...
import { Bike, Book, Clock, QrCode, Search, Users } from 'lucide-react'
...
const HomePage = () => {
    ...
    return (
        <div className='min-h-screen px-6 pt-8 relative'>
            {/* Header */}
            <header className="absolute px-6 pt-11 left-0 top-0 w-full h-[272px] bg-cover bg-center mb-4 rounded-b-[32px]"
            ...
            <div className='h-screen w-full relative top-44'>
                {/* Balance Card */}
                <div className="relative h-[180px]  shadow-md bg-cover bg-center rounded-2xl p-6 mb-6"
                    ...
                    <div className="grid grid-cols-3 gap-4 mb-6">
                        <div className="flex flex-col items-center">
                            <div className="bg-white/10 rounded-xl mb-1">
                                <img src={IconBicycle} alt="Trạm xe" className='w-8' />
                            </div>
                            <span className="text-[8px] text-center">Trạm xe <br /> gần đây</span>
                        </div>
                        <div className="flex flex-col items-center">
                            <div className="bg-white/10 rounded-xl mb-1">
                                <img src={IconOpenBook} alt="" className='w-8' />
                            </div>
                            <span className="text-[8px] text-center">Hướng dẫn <br /> sử dụng</span>
                        </div>
                        <div className="flex flex-col items-center">
                            <div className="bg-white/10 rounded-xl mb-1">
                                <img src={IconUser} alt="" className='w-8' />
                            </div>
                            <span className="text-[8px] text-center">Hỗ trợ <br /> người dùng</span>
                        </div>
                    </div>
                </div>
