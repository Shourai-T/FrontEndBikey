    ...
    return (
        <div className='min-h-screen px-6 pt-8 relative'>
            ...
            <div className='h-screen w-full relative top-44'>
                <div className="relative h-[180px] shadow-md bg-cover bg-center rounded-2xl p-6 mb-6" style={{ backgroundImage: `url(${BgBalanceCard})` }}>
                    ...
                    <div className="flex justify-between mt-8">
                        <button onClick={() => navigate('/deposit')} className="flex items-center justify-center gap-2 border border-[#102590] text-[#102590] w-[133px] h-[36px] rounded-full">
                            <FontAwesomeIcon icon={faCreditCard} />
                            <span className="text-[8px]">Nạp tiền</span>
                        </button>
                        <button onClick={() => navigate('/history')} className="flex items-center justify-center gap-2 border border-[#102590] text-[#102590] w-[133px] h-[36px] rounded-full">
                            <Clock size={16} />
                ...
                <div className="rounded-2xl overflow-hidden border border-[#102590] relative mb-8">
                    <img src={Banner} alt="Promotion" className="w-full h-48 object-cover" />
                    <div className="absolute bottom-3 left-14 right-0 p-6">
                        <button className="text-[#102590] px-4 py-2 rounded-full text-[8px] font-medium border border-[#102590]">Quét mã ngay!</button>
                    </div>
                </div>
            </div>
        </div>
